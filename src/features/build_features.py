...
# Load data
# --------------------------------------------------------------
df = pd.read_pickle("../../data/interim/02_outliers_remove_chauvenets.pkl")
...
# --------------------------------------------------------------
# subset = df[df['acc_y'].isna()]['acc_y'].index

for col in predictor_columns:
    df[col] = df[col].interpolate()

# df.loc[:subset[0]]['acc_y'][-3:]
# df.loc[subset[0]:]['acc_y'][:3]
# --------------------------------------------------------------
...
# plt.plot(df[df['category'] == 'medium']['duration'].unique())
